document.addEventListener('DOMContentLoaded', () => {
    ...
    checkBtn.addEventListener('click', async () => {
        ...
        const formUrl = 'https://docs.google.com/forms/d/e/1FAIpQLSe7UeaOV6b0c-JbXOeeqX2fYkQ9xpg6CV4s855T12v3QUQyeg/formResponse';

        const formParams = new URLSearchParams();
        formParams.append('entry.98732108', studentName);
        formParams.append('entry.2119622499', schoolName);
        formParams.append('entry.816713813', finalScore);
        formParams.append('entry.1474008907', 'Formative Assessment Lesson 4');
