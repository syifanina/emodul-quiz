document.addEventListener('DOMContentLoaded', () => {
    ...
    checkBtn.addEventListener('click', async () => {
        ...
        for (let i = 0; i < sec2Inputs.length; i++) {
            ...
            // Normalize by removing dots and standardizing/removing apostrophes to ensure flexible matching
            const normalizeStr = (str) => str.replace(/['’\.]/g, '').trim().toUpperCase();
        ...
        const finalScore = totalPoints * 2.5;
        ...
        const formUrl = 'https://docs.google.com/forms/d/e/1FAIpQLSezDUL924Q4S6yCwhbx9GNQRZLZwZk03t7HlmqpejHFTfTFgQ/formResponse';

        const formParams = new URLSearchParams();
        // Asumsi urutan pertanyaan di Google Form: Nama, Sekolah, Nilai, Nama Asesmen
        formParams.append('entry.1204120414', studentName);
        formParams.append('entry.671970507', schoolName);
        formParams.append('entry.1198783415', finalScore);
        formParams.append('entry.612297068', 'Formative Assessment Lesson 2');
