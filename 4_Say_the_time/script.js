document.addEventListener('DOMContentLoaded', () => {
    ...
    // Exact physical file names on disk mapping (includes trailing spaces and specific case extensions)
    const audioFiles = {
        'one': 'one.MP3',
        'two': 'two.MP3',
        'three': 'three.MP3',
        ...
        'eleven': 'eleven.MP3',
        'twelve': 'twelve.MP3',
        'five-past-a-half': 'five-past-a-half.MP3',
        'eight-past-a-half': 'eight-past-a-half..MP3', // Maps to newly uploaded physical file name
        'fifteen-minutes-to-seven': 'fifteen-minutes-to-seven .MP3', // has space on disk
        'fifteen-minutes-past-six': 'fifteen-minutes-past-six .MP3'  // has space on disk
    };
    ...
    const playAction = (card) => {
        ...
        // Play corresponding clock audio
        const audioSrc = audioFiles[actionName];
        if (audioSrc) {
            audio.src = audioSrc;
            audio.play().catch(err => console.warn(`Audio playback failed for ${audioSrc}:`, err));
        }
    ...
    // Gracefully handle playback error if an audio file is missing (like the placeholder eight-past-a-half.MP3)
