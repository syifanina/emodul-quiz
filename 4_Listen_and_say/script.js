document.addEventListener('DOMContentLoaded', () => {
    ...
    const audioSources = [
        ...
        'eleven.MP3',
        'twelve.MP3',
        'five-past-a-half.MP3',
        'eight-past-a-half.MP3', // Placeholder, will gracefully skip if not uploaded yet
        'fifteen-minutes-to-seven .MP3', // Space matches physical filename on disk
        'fifteen-minutes-past-six .MP3'  // Space matches physical filename on disk
    ];
    ...
    audio.addEventListener('error', () => {
        ...
        if (isPlayingContinuous) {
            // Automatically skip to the next phrase after a 1s delay if audio is missing
            setTimeout(() => {
                currentPhraseIndex++;
                if (currentPhraseIndex < phrases.length) {
                    playAudioForIndex(currentPhraseIndex);
